...
public class AutonTest extends CommandGroup {
    ...
    public  AutonTest() {
    	...
    	addSequential(new DriveSlowBackward(1.0));
    	addSequential(new AutonFastTurnLeft(1.0));
    	addSequential(new AutonSlowTurnLeft(1.0));
    	addSequential(new AutonFastTurnRight(1.0));
    	addSequential(new AutonSlowTurnRight(1.0));
    	addSequential(new AutonRollerShoot(1.0));
    	addSequential(new AutonRollerIntake(1.0));
    	addSequential(new AutonShooterPivotUp(1.0));
    	addSequential(new AutonShooterPivotDown(1.0));
