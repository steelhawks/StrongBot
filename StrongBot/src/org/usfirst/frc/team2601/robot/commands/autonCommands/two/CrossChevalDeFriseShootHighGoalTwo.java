package org.usfirst.frc.team2601.robot.commands.autonCommands.two;
 ...
 *
 */
public class CrossChevalDeFriseShootHighGoalTwo extends CommandGroup {
    
    public  CrossChevalDeFriseShootHighGoalTwo() {
    	...
    	addSequential(new AutonFastTurnRight(0.7));
    	Timer.delay(0.1);
