 ...
 *
 */
public class AutonShooterPivotDown extends Command {

    public AutonShooterPivotDown(double timeout) {
    ...
    protected void execute() {
    	//Robot.shooterPivot.autonShooterPivotDown();
    	Robot.combinedshooter.autonShooterPivotDown();
    }
