 ...
 *
 */
public class AutonShooterPivotUp extends Command {

    public AutonShooterPivotUp(double timeout) {
    ...
    protected void execute() {
    	//Robot.shooterPivot.autonShooterPivotUp();
    	Robot.combinedshooter.autonShooterPivotUp();
    }
